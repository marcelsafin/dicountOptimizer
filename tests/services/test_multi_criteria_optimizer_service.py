...
def basic_optimization_input(
    ...
    discount_item_high_savings: dict,
    discount_item_low_savings: dict
) -> OptimizationInput:
    """Fixture providing basic optimization input."""
    return OptimizationInput(
        ingredient_matches={
            'milk': [discount_item_high_savings, discount_item_low_savings]
        },
...
def test_optimize_minimize_stores(
    user_location: Location,
    discount_item_high_savings: dict,
    store_location_nearby: Location
):
...
def test_optimize_prefer_organic(user_location: Location):
    ...
    input_data = OptimizationInput(
        ingredient_matches={
            'milk': [organic_item, regular_item]
        },
        preferences=OptimizationPreferences(
            maximize_savings=False,
            minimize_stores=False,
...
def test_calculate_optimal_purchase_day_urgent():
    ...
    purchase_day = service._calculate_optimal_purchase_day(
        expiration_date,
        timeframe_start
    )
...
def test_generate_optimization_notes_single_store():
    ...
    notes = service._generate_optimization_notes(
        preferences,
        store_summary,
        total_savings
    )
