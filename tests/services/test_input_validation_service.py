...
def valid_input_with_coordinates() -> ValidationInput:
    ...
    return ValidationInput(
        latitude=55.6761, longitude=12.5683, timeframe="next 7 days", maximize_savings=True
    )
...
def test_input_validation_valid_with_address():
    ...
    input_data = ValidationInput(
        address="Copenhagen, Denmark", timeframe="this week", maximize_savings=True
    )
...
def test_input_validation_valid_with_coordinates():
    ...
    input_data = ValidationInput(
        latitude=55.6761, longitude=12.5683, timeframe="next 3 days", maximize_savings=True
    )
...
def test_input_validation_valid_with_meal_plan():
    ...
    input_data = ValidationInput(
        address="Aarhus, Denmark", meal_plan=["Taco", "Pasta", "Salad"], timeframe="this week"
    )
...
async def test_validate_location_with_invalid_address(
    agent: InputValidationService, mock_geocoding_service: MockGeocodingService
):
    """Test that invalid address produces validation error."""
    input_data = ValidationInput(
        address="Invalid Address That Cannot Be Geocoded", timeframe="this week"
    )
...
async def test_validate_location_missing_both_address_and_coordinates(
    ...
    input_data = ValidationInput(timeframe="this week", maximize_savings=True)
...
async def test_validate_timeframe_this_week(
    agent: InputValidationService, valid_input_with_coordinates: ValidationInput
):
    """Test that 'this week' timeframe is parsed correctly."""
    input_data = ValidationInput(latitude=55.6761, longitude=12.5683, timeframe="this week")
...
async def test_validate_timeframe_today(
    ...
    input_data = ValidationInput(latitude=55.6761, longitude=12.5683, timeframe="today")
...
async def test_validate_timeframe_next_3_days(
    ...
    input_data = ValidationInput(latitude=55.6761, longitude=12.5683, timeframe="next 3 days")
...
async def test_validate_timeframe_next_week(
    ...
    input_data = ValidationInput(latitude=55.6761, longitude=12.5683, timeframe="next week")
...
async def test_validate_timeframe_too_long(
    ...
    input_data = ValidationInput(latitude=55.6761, longitude=12.5683, timeframe="next 45 days")
...
async def test_validate_timeframe_unparseable_defaults_with_warning(
    ...
    input_data = ValidationInput(latitude=55.6761, longitude=12.5683, timeframe="some random text")
...
async def test_validate_search_radius_custom(
    ...
    input_data = ValidationInput(
        latitude=55.6761, longitude=12.5683, timeframe="this week", search_radius_km=10.0
    )
...
async def test_validate_meal_plan_with_meals(
    agent: InputValidationService, valid_input_with_meal_plan: ValidationInput
):
...
async def test_validate_meal_plan_empty_means_ai_suggestions(
    ...
    input_data = ValidationInput(
        latitude=55.6761, longitude=12.5683, timeframe="this week", meal_plan=[]
    )
...
async def test_validate_num_meals_custom(
    ...
    input_data = ValidationInput(
        latitude=55.6761, longitude=12.5683, timeframe="this week", num_meals=5
    )
...
async def test_complete_validation_flow_success(
    agent: InputValidationService, valid_input_with_address: ValidationInput
):
...
@pytest.mark.asyncio
async def test_complete_validation_flow_multiple_errors(agent: InputValidationService):
