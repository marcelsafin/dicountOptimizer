...
def redis_cache(mock_redis_client, mock_redis_pool):
    ...
    with patch('agents.discount_optimizer.infrastructure.redis_cache_repository.redis.ConnectionPool') as mock_pool_class:
        with patch('agents.discount_optimizer.infrastructure.redis_cache_repository.redis.Redis') as mock_redis_class:
...
class TestCacheFactory:
    ...
    def test_create_redis_cache(self):
        ...
        with patch('agents.discount_optimizer.infrastructure.redis_cache_repository.redis.ConnectionPool'):
            with patch('agents.discount_optimizer.infrastructure.redis_cache_repository.redis.Redis'):
