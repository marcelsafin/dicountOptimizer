...
def demo_optimized_workflow():
    ...
    try:
        ...
        print("  • Helps reduce food waste by using products before expiration")
        print("  • Maximizes savings with high-discount items")
        print()

    except Exception as e:
        print("⚠️  Note: Gemini API temporarily unavailable")
