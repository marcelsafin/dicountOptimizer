...
class GoogleMapsService:
    ...
    def geocode_address(self, address: str) -> Location:
        ...
        if address in self._geocoding_cache:
            ...
            if datetime.now() - cached_time < timedelta(hours=self._cache_ttl_hours):
